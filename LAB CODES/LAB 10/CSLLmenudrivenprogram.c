...
struct node *start = NULL, *NN, *temp, *temp2, *temp3, *current;
...
int main()
{
    ...
    do
    {
        int choice;
        printf("\nEnter the choice: \n");
        printf("Enter 1 for creation of CSLL\n");
        printf("Enter 2 for insertion at the beginning of CSLL\n");
        printf("Enter 3 for insertion at a given position of CSLL\n");
        printf("Enter 4 for insertion before a given position of CSLL\n");
        printf("Enter 5 for insertion after a given position of CSLL\n");
        printf("Enter 6 for insertion at the end of CSLL\n");
        printf("Enter 7 for deletion from the beginning of CSLL\n");
        printf("Enter 8 for deletion from a given position of CSLL\n");
        printf("Enter 9 for deletion before a given position of CSLL\n");
        printf("Enter 10 for deletion after a given position of CSLL\n");
        printf("Enter 11 for deletion at the end of DLL\n");
        printf("Enter 12 for deletion by value of DLL\n");
        printf("Enter 13 for searching in DLL\n");
        printf("Enter 14 for display DLL\n");
        scanf("%d", &choice);
