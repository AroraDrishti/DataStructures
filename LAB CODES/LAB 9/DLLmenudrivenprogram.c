...
int main()
{
    ...
    do
    {
        ...
        printf("Enter 4 for insertion before a given position of DLL\n");
        printf("Enter 5 for insertion after a given position of DLL\n");
        printf("Enter 6 for insertion at the end of DLL\n");
        printf("Enter 7 for deletion from the beginning of DLL\n");
        printf("Enter 8 for deletion from a given position of DLL\n");
        printf("Enter 9 for deletion before a given position of DLL\n");
        printf("Enter 10 for deletion after a given position of DLL\n");
